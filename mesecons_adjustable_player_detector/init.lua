...
minetest.register_node("mesecons_adjustable_player_detector:player_detector_off", {
	tiles = {"default_steel_block.png", "default_steel_block.png", "mesecons_player_detector_off.png"},
	paramtype = "light",
	walkable = true,
	groups = {cracky=3},
...
minetest.register_node("mesecons_adjustable_player_detector:player_detector_on", {
	tiles = {"default_steel_block.png", "default_steel_block.png", "mesecons_player_detector_on.png"},
	paramtype = "light",
	walkable = true,
	groups = {cracky=3,not_in_creative_inventory=1},
	drop = 'mesecons_adjustable_player_detector:player_detector_off',
	mesecons = {receptor = {
...
minetest.register_craft({
	output = 'mesecons_adjustable_player_detector:player_detector_off',
	recipe = {
...
minetest.register_abm({
	nodenames = {"mesecons_adjustable_player_detector:player_detector_off"},
	interval = 1.0,
	chance = 1,
	action = function(pos)
		if object_detector_scan(pos) then
			minetest.swap_node(pos, {name = "mesecons_adjustable_player_detector:player_detector_on"})
...
minetest.register_abm({
	nodenames = {"mesecons_adjustable_player_detector:player_detector_on"},
	interval = 1.0,
	chance = 1,
	action = function(pos)
		if not object_detector_scan(pos) then
			minetest.swap_node(pos, {name = "mesecons_adjustable_player_detector:player_detector_off"})
